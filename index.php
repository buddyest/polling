        ...
        <div class="container mb-4 mt-5">
          ...
          <div class="row">
            <div class="col-md-4 text-center p-5 news-blog border-bottom-0">
              ...
              <p class="">Lorem IpsumLorem IpsumLorem IpsumLorem IpsumLorem IpsumLorem IpsumLorem IpsumLorem Ipsum</p>
            </div>
            <div class="col-md-4 text-center p-5 news-blog offset-md-1">
              <h4>News Article</h4>
              <i class="fas fa-newspaper"></i>
              <p class="">Lorem IpsumLorem IpsumLorem IpsumLorem IpsumLorem IpsumLorem IpsumLorem IpsumLorem Ipsum</p>
            </div>
          ...
          <div class="row">
            <div class="col-md-4 text-center p-5 news-blog">
              <h4>News Article</h4>
              <i class="fas fa-newspaper"></i>
              <p class="">Lorem IpsumLorem IpsumLorem IpsumLorem IpsumLorem IpsumLorem IpsumLorem IpsumLorem Ipsum</p>
            </div>
